...
gcta_v1.94.0Beta_linux_kernel_3_x86_64/gcta_v1.94.0Beta_linux_kernel_3_x86_64_static --reml --grm ${1} --pheno ${1}_phenotypes.phen --out ${1}_REML --threads 2 > ${1}_tmp.out
