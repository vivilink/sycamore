...
os.chdir("~/plink_files_analysis_chromosomes/chr5/")

pca = open("~/ARGWAS/hawaiian/plink_files_wholeGenome_original/PC100/nh.megaandgda.geno05.hwe1e-6.ld50-5-.8.maf01.rmvChr5.100pcs.smartpca.evec", "r")
