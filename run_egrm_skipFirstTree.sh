...
./egrm/bin/trees2egrm --output ${2} ${3} --c-extension --skip-first-tree --output-format gcta ${1} 

./egrm/bin/trees2egrm --output ${2} ${3} --c-extension --skip-first-tree --output-format numpy ${1} 
