...
class TSimulatorStdPopsim(TSimulator):
    ...
    def run_simulation(self, N, out, randomGenerator, logfile):
        ...
        samples = model.get_samples(N, 0, 0) # Returns a list of msprime.Sample objects, with the number of samples from each population determined by the positional arguments.
